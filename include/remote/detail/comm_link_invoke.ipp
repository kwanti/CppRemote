...
{
	Proxy _proxy(shared_from_this(), name);
	return (_proxy.*mem_fn)();
}
...
{
	Proxy _proxy(shared_from_this(), name);
	return (_proxy.*mem_fn)(a1, a2, a3, a4);
}
...
{
	Proxy _proxy(shared_from_this(), name);
	return (_proxy.*mem_fn)(a1, a2, a3, a4, a5);
}
...
{
	Proxy _proxy(shared_from_this(), name);
	return (_proxy.*mem_fn)(a1, a2, a3, a4, a5, a6);
}
